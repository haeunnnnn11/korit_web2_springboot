...
public class IocController {
    ...
    public ResponseEntity<?> diTest() throws JsonProcessingException {
        ...
        //자바객체->JSON(문자열) by jackson라이브러리(objectMapper)
        ...
        return ResponseEntity
                ...
                .contentType(MediaType.APPLICATION_JSON) //body 자료구조지정(헤더)
                .body(jsonData); //body 데이터 //body 데이터(헤더)
    ...
    //외부 라이브러리 사용시 유틸리티 클래스의 객체를 bean으로 만들고 싶을 땐
    //->@Configuration
