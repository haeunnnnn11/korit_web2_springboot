...
public class IocService {
    ...
    /*
    스프링부트에서는 객체생성(new)/의존성주입(di) 주도권이 내가 아니라 프레임워크(스프링부트)에 있다.
    ...
    //탐색 범위- run()한곳이  포함된 패키지를 기준으로 하위 전체.
   ...
   // @Autowired //시점 (2)에서 주입
    ...
    A를 만드려고하니 B가 필요하네? B 만들자
    B를 만드려고하니 A가 필요하네?  A 만들자... 무한반복
