...
/* product
상품이름이 같을 수도 있음->product_name을 PK로 쓸 수 없음
product_id PK
product_name
product_price
*/
...
product_id FK
quantity
--그냥 ordersdp quantity 넣으면 안 될까?
order_id가 1인 경우,노트북 1개, 마우스 2개
order_id customer_id product_id quantity
1			1			1		1 #노트북 1개
1			1			2		1 #마우스 2개=> order_id가 PK인데 중복되게 됨
...
2.order_id가 중복되야한다. -> orders테이블은ㅇ 불가능하구나
